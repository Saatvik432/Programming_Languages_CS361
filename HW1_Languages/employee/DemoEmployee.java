...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		// This instruction returns a ClassCastException at run time because we have not checked if 
		// emp1 is an instance Part Time Employee, since it is actually an instance of Employee, 
		// we cannot cast it so it does compile but comes across this problem during runtime
